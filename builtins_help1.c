...
/**
 * hlp_all - Displays all possible builtin shell commands.
 */
void hlp_all(void)
{
...
/**
 * hlp_alias - Displays information on the shell builtin command 'alias'.
 */
void hlp_alias(void)
{
...
/**
 * hlp_cd - Displays information on the shell builtin command 'cd'.
 */
void hlp_cd(void)
{
...
/**
 * hlp_exit - Displays information on the shell builtin command 'exit'.
 */
void hlp_exit(void)
{
...
/**
 * hlp_help - Displays information on the shell builtin command 'help'.
 */
void hlp_help(void)
{
